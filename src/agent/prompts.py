"""FHIR Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are FHIR Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to FHIR Agent operations:
...
REPORT_PROMPT = """Generate a structured report for FHIR Agent:
