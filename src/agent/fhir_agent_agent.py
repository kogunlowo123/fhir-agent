"""FHIR Agent - Main Agent Implementation."""
...
class FhirAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "query_fhir_resource": self.tools.query_fhir_resource,
            "create_fhir_resource": self.tools.create_fhir_resource,
            "validate_fhir_resource": self.tools.validate_fhir_resource,
            "map_data_format": self.tools.map_data_format,
            "bulk_export": self.tools.bulk_export,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['fhir', 'compliance', 'interoperability'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "query_fhir_resource": ['query', 'fhir', 'resource'],
            "create_fhir_resource": ['create', 'fhir', 'resource'],
            "validate_fhir_resource": ['validate', 'fhir', 'resource'],
            "map_data_format": ['map', 'data', 'format'],
