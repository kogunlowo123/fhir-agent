"""FHIR Agent - Domain-Specific Connectors."""
...
class EpicEhrConnector:
    """Domain-specific connector for epic ehr integration with FHIR Agent."""
...
class CernerEhrConnector:
    """Domain-specific connector for cerner ehr integration with FHIR Agent."""
...
class AllscriptsConnector:
    """Domain-specific connector for allscripts integration with FHIR Agent."""
...
class FhirServerConnector:
    """Domain-specific connector for fhir server integration with FHIR Agent."""
...
class ClearinghouseConnector:
    """Domain-specific connector for clearinghouse integration with FHIR Agent."""
